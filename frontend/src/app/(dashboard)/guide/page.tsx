...
const SECTIONS: GuideSection[] = [
  ...
  {
    id: 'boost', emoji: '📈', title: 'האצת מודעות אוטומטית (Meta Ads)', minPlan: 'growth',
    body: (
      <>
        <P>פוסט שמוכיח ביצועים אורגניים יכול לקבל דחיפה ממומנת אוטומטית בפייסבוק/אינסטגרם — עם סף ROAS, תקציב יומי ותקרת הוצאה קשיחה שאתם קובעים בהגדרות. המערכת לא תחרוג מהתקרה לעולם.</P>
      </>
    ),
  },
  {
